...
def main():
    ...
    st.title("GRSF Counterfactual Generation")
    st.markdown("Welcome to the GRSF Counterfactual Generation application!")
    st.markdown("""
# Gabin Vrillault
...
(from arXiv:1804.00792)
    ...
    st.latex(r'''
    \begin{aligned}
    &\text{Algorithm 1 Couterfactual Example Generation}\\
    ...
    # Add the illustration from ../static/algorithm.png
    st.image("static/algorithm.png", caption="Counterfactuals Generation Algorithm", use_container_width=True)
